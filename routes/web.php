...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:Operator', 'permission:view operator dashboard'])->prefix('operator')->name('operator.')->group(function () {
        ...
        Route::prefix('transkrip')->name('transcript.')->group(function () {
            ...
            Route::get('cetak/kelas/zip', [\App\Http\Controllers\Operator\TranscriptPrintController::class, 'classroomZip'])->name('print.classroom.zip');
            Route::put('cetak-ulang/siswa/{student}/koreksi', [\App\Http\Controllers\Operator\TranscriptReprintCorrectionController::class, 'update'])->name('print.corrections.update');
    ...
    Route::middleware(['role:Super Admin'])->prefix('super-admin')->name('super-admin.')->group(function () {
        ...
        Route::get('/telegram-links/export', [\App\Http\Controllers\Admin\TelegramBotController::class, 'exportExcel'])->name('telegram-links.export');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:Operator|KAUR SDM'])->group(function () {
        ...
        Route::post('/dapodik-tpa/{dapodikGuru}/account', [\App\Http\Controllers\Shared\DapodikGuruController::class, 'createTpaAccount'])->name('dapodik-tpa.account.create');
...
Route::middleware(['auth', 'role:Guru Kelas|Guru Piket|Wali Kelas|Waka Kesiswaan|Kurikulum|KAUR SDM|KAUR SARPRA|Kepala Sekolah|Super Admin|Petugas UKS'])
    ...
    ->group(function () {
        ...
        Route::post('/manual/{manualDocument}/continue', [\App\Http\Controllers\ManualDigitalSignatureController::class, 'continueSign'])->name('manual.continue');
        Route::get('/manual/{manualDocument}/preview', [\App\Http\Controllers\ManualDigitalSignatureController::class, 'preview'])->name('manual.preview');
