    ...
    <ul class="space-y-1 font-medium">
        ...
        @if(session('active_role') == 'Siswa')
            ...
            <li>
                <a href="{{ route('siswa.chat.index') }}"
                    ...
                    <template x-if="unreadChatCount > 0">
                        <span class="bg-red-600 text-white text-[10px] font-black px-1.5 py-0.5 rounded-full"
            ...
            <li>
                <a href="{{ route('siswa.kartu-pelajar.index') }}"
                    ...
                    <span
                        class="bg-blue-100 text-blue-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">NEW</span>
                </a>
            </li>
            <li>
                ...
                @can('view monitoring keterlambatan')
                    ...
                    <li>
                        <a href="{{ route('kesiswaan.analisa-keterlambatan.index') }}"
                            class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('kesiswaan.analisa-keterlambatan.index') ? 'bg-red-50 text-red-700' : 'text-gray-700 hover:bg-red-50 hover:text-red-700' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            <span class="text-sm">Analisa Keterlambatan</span>
                        </a>
                    </li>
                @endcan
                @can('view coaching analytics')
            ...
            @can('manage kartu akses')
                <li>
                    <a href="{{ route('kesiswaan.kartu-akses.index') }}"
                        ...
                        <span
                            class="bg-indigo-100 text-indigo-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">NEW</span>
                    </a>
                </li>
            @endcan
            ...
            @can('manage database maintenance')
                <li>
                    <a href="{{ route('kesiswaan.database.index') }}"
                        ...
                        <span
                            class="bg-red-100 text-red-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">SAFE</span>
                    </a>
                </li>
            @endcan
        @endif
                ...
                @can('manage dapodik')
                    ...
                    <li>
                        <a href="{{ route('operator.dapodik.submissions.index') }}"
                            ...
                            @if ($pendingCount > 0)
                                <span
                                    class="bg-red-100 text-red-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">{{ $pendingCount }}</span>
                            @endif
                        </a>
                    </li>
                @endcan
        ...
        <li>
            <a href="{{ route('changelog.index') }}"
                ...
                <span
                    class="bg-blue-100 text-blue-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">v1.0</span>
            </a>
        </li>
