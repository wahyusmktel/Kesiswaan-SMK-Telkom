...
@if((session('active_role') ?: auth()->user()?->getRoleNames()->first()) !== 'Kepala Sekolah')
    ...
    <li>
        <a href="{{ route('erapor.index') }}" title="e-Rapor SISFO"
            class="nav-link {{ request()->routeIs('erapor.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
...
@if(session('active_role') == 'Super Admin')
    ...
    <li>
        <a href="{{ route('super-admin.dashboard.index') }}" title="Dashboard Super Admin"
            ...
            <span class="nav-text">Dashboard Super Admin</span>
        </a>
    </li>
    @can('view users')
        <li>
    ...
    @can('manage settings')
        <li>
            <a href="{{ route('super-admin.asset-sync.index') }}"
                class="nav-link {{ request()->routeIs('super-admin.asset-sync.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
                <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg></div>
                <span class="nav-text">Sinkronisasi Aset</span>
            </a>
        </li>
        <li>
    ...
    <li>
        <a href="{{ route('super-admin.system-update.index') }}"
            ...
            <span class="nav-badge bg-green-100 text-green-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">GIT</span>
        </a>
    </li>
    ...
    <li>
        <a href="{{ route('super-admin.berita.index') }}"
            ...
            <span class="nav-badge bg-blue-100 text-blue-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">NEW</span>
        </a>
    </li>

    <li>
        <a href="{{ route('super-admin.berita-comments.index') }}"
            class="nav-link {{ request()->routeIs('super-admin.berita-comments.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li class="submenu-dropdown" x-data="{ expanded: {{ request()->routeIs('fingerprint.*') ? 'true' : 'false' }}, flyoutTop:0, updateFlyoutPosition(){ const r=this.$el.querySelector('button').getBoundingClientRect(); this.flyoutTop=r.top; } }" @mouseenter="updateFlyoutPosition()">
        ...
        <div x-show="expanded" x-collapse class="submenu-card">
            ...
            <a href="{{ route('fingerprint.time-settings') }}" class="submenu-item {{ request()->routeIs('fingerprint.time-settings', 'fingerprint.time-settings.update') ? 'submenu-item-active' : '' }}"><span class="submenu-dot"></span>Seting Waktu</a>
            ...
            <a href="{{ route('fingerprint.reports.index') }}" class="submenu-item {{ request()->routeIs('fingerprint.reports.*') ? 'submenu-item-active' : '' }}"><span class="submenu-dot"></span>Laporan Kehadiran</a>
        ...
        <div class="submenu-flyout" :style="'top: ' + flyoutTop + 'px'">
            ...
            <a href="{{ route('fingerprint.time-settings') }}" class="submenu-item {{ request()->routeIs('fingerprint.time-settings', 'fingerprint.time-settings.update') ? 'submenu-item-active' : '' }}">Seting Waktu</a>
            ...
            <a href="{{ route('fingerprint.reports.index') }}" class="submenu-item {{ request()->routeIs('fingerprint.reports.*') ? 'submenu-item-active' : '' }}">Laporan Kehadiran</a>
...
@if(in_array(session('active_role'), ['TPA', 'KAUR SDM']))
    <div class="section-title">Layanan Pegawai</div>
    <li>
        <a href="{{ route('guru.izin.index') }}"
            ...
            <span class="nav-text">Pengajuan Izin Pegawai</span>
        </a>
    </li>
@endif

{{-- ============================================================ --}}
{{-- ROLE: KEPALA SEKOLAH (MONITORING / READ-ONLY) --}}
{{-- ============================================================ --}}
@role('Kepala Sekolah')
@if(session('active_role') == 'Kepala Sekolah')
    <div class="section-title">Monitoring Eksekutif</div>
    <li>
        <a href="{{ route('kepala-sekolah.dashboard.index') }}" title="Dashboard Eksekutif"
            class="nav-link {{ request()->routeIs('kepala-sekolah.dashboard.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <li>
        <a href="{{ route('okr.index') }}" title="Perkembangan Seluruh Unit"
...
@if(session('active_role') == 'KAUR SARPRA')
    ...
    <li>
        <a href="{{ route('tanda-tangan.index') }}" title="Tanda Tangan Digital"
            class="nav-link {{ request()->routeIs('tanda-tangan.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
...
@if(session('active_role') == 'Siswa')
    ...
    <li>
        <a href="{{ route('siswa.certificates.index') }}"
            class="nav-link {{ request()->routeIs("siswa.certificates.*") ? "nav-link-active" : "nav-link-inactive" }}">
            <div class="nav-icon-container">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                </svg>
            </div>
            <span class="nav-text">Portofolio Sertifikat</span>
        </a>
    </li>
    <li>
        <a href="{{ route('siswa.showcase.index') }}"
            class="nav-link {{ request()->routeIs("siswa.showcase.*") ? "nav-link-active" : "nav-link-inactive" }}">
            <div class="nav-icon-container">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                </svg>
            </div>
            <span class="nav-text">Pameran Karya</span>
        </a>
    </li>
    ...
    @if (Auth::user()->masterSiswa?->penempatan()->exists())
        ...
        <li>
            <a href="{{ route('siswa.prakerin-konsultasi.index') }}"
                class="nav-link {{ request()->routeIs("siswa.prakerin-konsultasi.*") ? "nav-link-active" : "nav-link-inactive" }}">
                <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
@can('manage buku induk')
    <div class="section-title">Administrasi Kelas</div>
    <li>
        <a href="{{ route('wali-kelas.buku-induk.index') }}"
            class="nav-link {{ request()->routeIs('wali-kelas.buku-induk.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <span class="nav-text">Buku Induk</span>
        </a>
    </li>
@endcan
...
@can('view guru kelas dashboard')
    ...
    @if(session('active_role') == 'Guru Kelas')
        ...
        <li>
            <a href="{{ route('guru-kelas.lesson-plan.index') }}"
                class="nav-link {{ request()->routeIs("guru-kelas.lesson-plan.*") ? "nav-link-active" : "nav-link-inactive" }}">
                <div class="nav-icon-container">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
        ...
        @endphp
            @if ($isPembimbingPrakerin)
                ...
                <li>
                    <a href="{{ route('pembimbing-prakerin.konsultasi.index') }}"
                        class="nav-link {{ request()->routeIs("pembimbing-prakerin.konsultasi.*") ? "nav-link-active" : "nav-link-inactive" }}">
                        <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 4v-4z" />
                            </svg></div>
                ...
                <li>
                    <a href="{{ route('pembimbing-prakerin.laporan.index') }}"
                        class="nav-link {{ request()->routeIs("pembimbing-prakerin.laporan.*") ? "nav-link-active" : "nav-link-inactive" }}">
                        <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0119 9.414V19a2 2 0 01-2 2z" />
                            </svg></div>
    ...
    @if(session('active_role') == 'KAUR SDM')
            ...
            <li>
                <a href="{{ route('manajemen-pegawai.index') }}"
                    class="nav-link {{ request()->routeIs('manajemen-pegawai.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
                    <div class="nav-icon-container">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@if(session('active_role') == 'Tata Usaha')
    ...
    <li>
        <a href="{{ route('tu.outgoing.index') }}"
            class="nav-link {{ request()->routeIs('tu.outgoing.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg></div>
    ...
    <li>
        <a href="{{ route('tu.requests.index') }}"
            class="nav-link {{ request()->routeIs('tu.requests.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg></div>
            <span class="nav-text">Antrean Nomor</span>
            @php $pendingCount = \App\Models\TuLetterRequest::where('status', 'pending')->count(); @endphp
            @if($pendingCount > 0)
                <span
                    class="nav-badge bg-red-600 text-white text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">{{ $pendingCount }}</span>
            @endif
        </a>
    </li>
@endif
...
@can('view operator dashboard')
    ...
    @if(session('active_role') == 'Operator')
        ...
        <li>
            <a href="{{ route('operator.kartu-pelajar.index') }}"
                class="nav-link {{ request()->routeIs('operator.kartu-pelajar.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
                <div class="nav-icon-container">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
    ...
    @if(session('active_role') == 'Koordinator Prakerin')
        <li class="submenu-dropdown" x-data="{ 
            ...
            <div x-show="expanded" x-collapse class="submenu-card">
                ...
                <a href="{{ route('prakerin.jurnal.index') }}"
                    class="submenu-item {{ request()->routeIs('prakerin.jurnal.index') ? 'submenu-item-active' : '' }}">
                    <span class="submenu-dot"></span>
                    Monitor Jurnal PKL
                </a>
                <a href="{{ route('prakerin.jurnal.analytics') }}"
                    class="submenu-item {{ request()->routeIs('prakerin.jurnal.analytics') ? 'submenu-item-active' : '' }}">
                    <span class="submenu-dot"></span>
                    Analisis Keaktifan
                </a>
            </div>
...
<li>
    <a href="{{ route('gallery-photo.index') }}"
        class="nav-link {{ request()->routeIs('gallery-photo.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
        <div class="nav-icon-container">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <span class="nav-text">Galery Photo</span>
    </a>
</li>
<li>
...
<li>
    <a href="{{ route('surveys.index') }}"
        class="nav-link {{ request()->routeIs('surveys.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
        <div class="nav-icon-container">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<li>
    <a href="{{ route('notted.landing') }}"
        class="nav-link {{ request()->routeIs('notted.landing') ? 'nav-link-active' : 'nav-link-inactive' }}">
        <div class="nav-icon-container">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
        ...
        <span class="nav-text">NOTTED Social</span>
        <span class="nav-badge bg-indigo-100 text-indigo-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">HOT</span>
    </a>
</li>
...
<li>
    <a href="{{ route('forum-stella.index') }}"
        ...
        <span class="nav-text">Forum Stella</span>
...
<li>
    <a href="{{ route('notted.games') }}"
        class="nav-link {{ request()->routeIs('notted.games') ? 'nav-link-active' : 'nav-link-inactive' }}">
        <div class="nav-icon-container">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M11 4a2 2 0 114 0v1a2 2 0 01-2 2H3a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1m-7 8a2 2 0 012-2h2a2 2 0 012 2v3a2 2 0 01-2 2H6a2 2 0 01-2-2v-3z" />
            </svg>
        </div>
        <span class="nav-text">Games</span>
        <span class="nav-badge bg-yellow-100 text-yellow-700 text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto">NEW</span>
    </a>
</li>
...
@can('manage tu letter requests')
    ...
    <li>
        <a href="{{ route('correspondence.request') }}"
            class="nav-link {{ request()->routeIs('correspondence.request') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg></div>
            <span class="nav-text">Permohonan Nomor</span>
        </a>
    </li>
@endcan
...
@can('view kantin dashboard')
    ...
    @if(session('active_role') == 'Kantin' || auth()->user()->roles->count() === 1)
        ...
        <li x-data="{ count: {{ \App\Models\KantinOrder::where('kantin_id', Auth::id())->where('status', 'pending')->count() }} }" @kantin-orders-updated.window="count = $event.detail.count">
            <a href="{{ route('kantin.orders.index') }}"
                class="nav-link {{ request()->routeIs('kantin.orders.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
                <div class="nav-icon-container">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                    </svg>
                </div>
                <span class="nav-text">Layanan Orderan</span>
                <span x-show="count > 0" x-text="count" class="nav-badge bg-red-500 text-white text-[10px] font-black px-1.5 py-0.5 rounded-full ml-auto animate-pulse"></span>
            </a>
        </li>
        <li>
            <a href="{{ route('kantin.menu.index') }}"
                class="nav-link {{ request()->routeIs('kantin.menu.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
                <div class="nav-icon-container">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                </div>
                <span class="nav-text">Katalog Makanan</span>
            </a>
        </li>
        <li class="h-px bg-gradient-to-r from-transparent via-slate-200/20 to-transparent mx-6 my-2"></li>
        <li>
            <a href="{{ route('kantin.settings.index') }}"
                class="nav-link {{ request()->routeIs('kantin.settings.*') ? 'nav-link-active' : 'nav-link-inactive' }}">
                <div class="nav-icon-container">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="nav-text">Pengaturan Kantin</span>
            </a>
        </li>
    @endif
    @endrole
...
{{-- ============================================================ --}}
{{-- KANTIN ONLINE (STUDENTS / STAFF) --}}
{{-- ============================================================ --}}
@if(session('active_role') != 'Kantin')
    <div class="section-title">Kantin Online</div>
    <li>
        <a href="{{ route('food-order.index') }}"
            class="nav-link {{ request()->routeIs('food-order.index', 'food-order.kantin') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container">
                <svg class="nav-icon text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
            </div>
            <span class="nav-text">Pesan Makanan</span>
        </a>
    </li>
    <li>
        <a href="{{ route('food-order.history') }}"
            class="nav-link {{ request()->routeIs('food-order.history', 'food-order.success') ? 'nav-link-active' : 'nav-link-inactive' }}">
            <div class="nav-icon-container">
                <svg class="nav-icon text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg>
...
@if(session('active_role') == 'Kaprodi')
    ...
    <li class="submenu-dropdown"
        ...
        {{-- also expand when on instrumen pages --}}
    </li>
@endif
@endrole
