<div x-data="{ show: false, item: {} }"
    @open-modal.window="if ($event.detail.name === 'detail-izin-bk') { show = true; item = $event.detail.item; }"
        ...
        <div x-show="show"
            ...
            <div class="px-4 py-5 sm:p-6 space-y-6">
                <div class="flex items-center gap-4 border-b border-gray-100 pb-4">
                    <div
                        class="h-12 w-12 rounded-full bg-violet-100 flex items-center justify-center text-violet-600 font-bold text-lg">
