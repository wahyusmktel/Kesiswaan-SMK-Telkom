<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-gray-800 leading-tight">Monitoring Perizinan Siswa</h2>
    </x-slot>
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                    <form action="{{ route('bk.monitoring.index') }}" method="GET">
                        <div class="flex flex-col lg:flex-row gap-4 items-end lg:items-center">
                            ...
                            <div class="w-full lg:w-1/4">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="search" value="{{ request('search') }}"
                                        class="pl-10 block w-full rounded-lg border-gray-300 bg-white text-sm focus:border-violet-500 focus:ring-violet-500 shadow-sm"
                            ...
                            <div class="w-full lg:w-1/4 flex gap-2">
                                <div class="w-1/2">
                                    ...
                                    <input type="date" name="start_date" value="{{ request('start_date') }}"
                                        class="block w-full rounded-lg border-gray-300 text-sm focus:border-violet-500 focus:ring-violet-500 shadow-sm">
                                </div>
                                <div class="w-1/2">
                                    <label
                            ...
                            <div class="w-full lg:w-auto flex gap-2">
                                <button type="submit"
                                    class="h-10 px-4 bg-violet-600 hover:bg-violet-500 text-white rounded-lg shadow-sm transition-colors text-sm font-semibold flex items-center justify-center gap-2">
                            ...
                            @forelse ($perizinan as $izin)
                                <tr class="bg-white hover:bg-gray-50/80 transition-colors duration-200"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <button @click="$dispatch('open-modal', { name: 'detail-izin-bk', item: item })"
    ...
    @include('pages.bk.monitoring.partials.modal-detail')
