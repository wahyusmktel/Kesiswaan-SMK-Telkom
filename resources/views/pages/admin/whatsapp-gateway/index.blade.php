                ...
                <div class="rounded-2xl border border-blue-200 bg-blue-50 p-5">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                        ...
                        <div class="flex flex-wrap items-end gap-2">
                            ...
                            <button type="button" @click="sendFingerprintNotificationsNow()" :disabled="sendingFingerprintNotifications" class="rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-bold text-white hover:bg-emerald-500 disabled:opacity-50" x-text="sendingFingerprintNotifications ? 'Mengantrekan...' : 'Kirim Pesan Sekarang'"></button>
                        </div>
                    </div>
...
<script>
    function whatsappGatewayApp() {
        return {
            ...
            loading: false,
            sendingTest: false,
            sendingFingerprintNotifications: false,
