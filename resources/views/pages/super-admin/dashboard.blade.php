        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-xs font-bold px-3 py-1 bg-blue-100 text-blue-700 rounded-full">Live Feed</span>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            @forelse($recentActivities as $activity)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 text-sm text-gray-900 font-medium">{{ $activity->filename ?? '-' }}</td>
                                    <td class="py-3">
                                    ...
                                    <td class="py-3 text-sm text-gray-400">{{ $activity->created_at->diffForHumans() }}</td>
                                </tr>
                            @empty
                                <tr>
