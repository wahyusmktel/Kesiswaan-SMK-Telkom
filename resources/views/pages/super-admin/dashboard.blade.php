        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm group">
                    ...
                    <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                        ...
                        <div>
                            <h4 class="text-gray-900 font-black text-xl uppercase tracking-tighter">
                                {{ $labels[$happinessSummary['dominant']] ?? $happinessSummary['dominant'] }}</h4>
                    ...
                    <div
                        class="bg-gradient-to-br from-pink-500 to-rose-600 rounded-3xl p-6 text-white shadow-lg relative overflow-hidden group">
                    ...
                    <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                        ...
                        <div class="space-y-3 max-h-64 overflow-y-auto">
                            @forelse($activeUsers as $user)
                                <div
                                    class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all">
                                    @if($user->avatar)
