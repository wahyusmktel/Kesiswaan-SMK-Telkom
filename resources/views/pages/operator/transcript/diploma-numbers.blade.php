<x-app-layout>
    <x-slot name="header"><div><h2 class="text-xl font-black text-slate-900">Nomor Ijazah</h2><p class="text-sm text-slate-500">Kelola nomor ijazah siswa kelas tingkat akhir untuk dokumen transkrip.</p></div></x-slot>
    <div class="py-8"><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" x-data="{ importOpen:false, reportOpen: {{ session('import_report') ? 'true' : 'false' }} }">
