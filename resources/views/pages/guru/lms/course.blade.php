    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex space-x-4">
                <a href="{{ route('guru.lms.material.create', ['rombel' => $rombel->id, 'mapel' => $mapel->id]) }}" class="px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 focus:bg-blue-500 active:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    + Tambah Materi
                </a>
                <a href="{{ route('guru.lms.assignment.create', ['rombel' => $rombel->id, 'mapel' => $mapel->id]) }}" class="px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-500 focus:bg-green-500 active:bg-green-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    + Buat Tugas
                </a>
            </div>
                                        ...
                                        <div class="flex justify-between items-start">
                                            <div>
                                                <h4 class="font-semibold text-md">
                                                    <a href="{{ route('guru.lms.assignment.show', $assignment->id) }}" class="hover:text-blue-600 hover:underline">
                                                        {{ $assignment->title }}
                                                    </a>
                                                </h4>
