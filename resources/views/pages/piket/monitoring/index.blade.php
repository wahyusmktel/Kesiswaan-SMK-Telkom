<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-gray-800 leading-tight">Monitoring Perizinan (Piket)</h2>
    </x-slot>
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                    <form action="{{ route('piket.monitoring.index') }}" method="GET">
                            ...
                            @forelse ($perizinan as $izin)
                                <tr class="bg-white hover:bg-gray-50/80 transition-colors duration-200"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <button
                                            @click="$dispatch('open-modal', { name: 'detail-izin-piket', item: item })"
    ...
    @include('pages.piket.monitoring.partials.modal-detail')
