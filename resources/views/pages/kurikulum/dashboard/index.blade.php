        ...
        <div class="w-full px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div class="lg:col-span-3">
                    <div
                        class="relative rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-lg overflow-hidden p-8 animate-gradient h-full">
                ...
                <div class="lg:col-span-1">
                    ...
                    @else
                        <div class="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-6 flex flex-col items-center justify-center text-center h-full group hover:border-blue-300 transition-colors">
                            <div class="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center mb-3 group-hover:bg-blue-50 transition-colors">
                                <svg class="w-6 h-6 text-gray-300 group-hover:text-blue-400 Transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
