                ...
                <div class="sticky top-28 flex flex-col gap-4">
                    <div class="bg-white rounded-3xl p-4 border border-slate-200 shadow-sm">
                        <div class="flex flex-col gap-1">
                            ...
                            <a href="{{ route('notted.reels') }}"
                                class="{{ request()->routeIs('notted.reels') ? 'sidebar-item-active' : 'text-slate-600 hover:bg-slate-50' }} flex items-center gap-4 px-4 py-3 rounded-2xl font-bold transition-all group">
                                <svg class="w-6 h-6 {{ request()->routeIs('notted.reels') ? 'text-white' : 'text-slate-400 group-hover:text-indigo-500' }}" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
