...
class DapodikGuruImport implements SkipsEmptyRows, ToCollection, WithStartRow
{
    ...
    public function __construct(private readonly string $employeeCategory = DapodikGuru::CATEGORY_TEACHER) {}
